...
@section('content')
    <div class="row expanded gblack ggreen">
        <div class="small-12 columns">
            <h2 style="font-size:112.5px; text-align: center;">x‐Glo</h2>
            <h2 style="font-size:150px; text-align: center;">LED</h2>
            <h3 style="font-size:48.75px; text-align: center;">Strip Lighting</h3>
        </div>
                    ...
                    @if($popups->popupId == $i)
                        @foreach($companies as $company)
                            @if ($company->id == $popups->companyId)
                                {{--{{$company}}--}}
                                <p style="color:black"> <span class="bolder">Company Name :  </span>{{$company->companyName}}<br/>
                                    <span class="bolder">Phone Number : </span>{{$company->phoneNumber}}<br/>
                                    <span class="bolder">Email : </span>{{$company->email}}<br/>
                                    <span class="bolder">Website : </span>{{$company->website}}<br/>
                                    <span class="bolder">Address : </span>{{$company->address}}</p>
                            @endif
                        @endforeach
                    @endif
                @endforeach
